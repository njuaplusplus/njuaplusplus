...
urlpatterns = [
    ...
    url(r'^author/(?P<username>[@\.+-_\w]+)/$', views.author_archive, name="author_archive_view"),
    url(r'^author/(?P<username>[@\.+-_\w]+)/page/(?P<page_num>[\d]+)/$', views.author_archive_page, name="author_archive_page_view"),
